        ...
        <div className="max-w-4xl mx-auto bg-gradient-to-r from-interview-purple to-interview-blue rounded-2xl p-10 text-center text-white shadow-2xl overflow-hidden relative animate-fade-in">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg mb-8 max-w-xl mx-auto text-white/90">
              Sign up today and start practicing with our AI interviewer. Get
              instant feedback and improve your chances of landing your dream
              job.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                className="bg-white text-interview-purple hover:bg-gray-100 text-lg px-8 py-6"
                asChild
              >
              ...
              <Button
                variant="outline"
                className="bg-transparent border-white text-white hover:bg-white hover:text-interview-purple text-lg px-8 py-6"
                asChild
              >
